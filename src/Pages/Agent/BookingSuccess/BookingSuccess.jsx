...
export default function BookingSuccess() {
  ...
  const handleOnSubmit = async (values, { resetForm }) => {
    ...
    console.log("setReInitialValues", setReInitialValues);

    console.log("valuesvaluesvaluesvalues",values);
   
    const dataString = JSON.stringify(reInitialValues);
    localStorage.setItem('print', dataString);


    console.log("setReInitialValues", reInitialValues);
    ...
    switch (action) {
      case "DownloadPDF":
        navigate(`/agent/ticketpdf/${bookingId/reInitialValues}`)
        break;
      case "PrintTicket":
        navigate(`/agent/ticketpdf/${bookingId}`)
                ...
                <div className="page-header">
                  ...
                  <div>
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li><a className="dropdown-item" href="#" onClick={() => dowanloadModalOpen("DownloadPDF")} ><i className="fa-regular fa-envelope"></i> Download  PDF</a></li>
