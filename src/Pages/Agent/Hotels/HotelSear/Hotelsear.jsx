                ...
                <Form ref={nameForm}>
                  <div className="row hotelsear">
                    ...
                    <div className="col-lg-2 col-md-3 mb-3">
                      <div className="form-group field-label w-100">
                        <InputLabel className="">Check-in</InputLabel>
                        {/* <input className="form-control p-3" type="date" /> */}
                        <DatePicker
                          className="form-control p-3 css-b62m3t-container"
                          selected={checkIn}
                          name='checkIn'
                          dateFormat="dd-MM-yy"
                    ...
                    <div className="col-lg-2 col-md-3 mb-3">
                      <div className="form-group field-label">
                        ...
                        <input className="form-control p-3 css-b62m3t-container" type="text" value={ratings.length > 0 ? ratings + " , " + "Star" : "Star"} onClick={() => handleCategoryShow()} />
                        {
                          hotelCategoryShow &&
