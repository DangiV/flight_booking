      ...
      >
        ...
        {/* <div style={{ display: "flex", flexDirection: "row", marginTop: "5px" }} >
          {listOfFlight && listOfFlight.map((flightValue, flightKey) => (
            <div>
              <div style={{ flex: 1, padding: "10px" }} key={flightValue.flightDetails?.flightId}>
                <div style={{ display: "flex" }}>
                  <img src={flightValue.flightDetails?.flightLogo} style={{ width: "80px", height: "70px" }} />
              ...
              <div style={{ flex: 3, padding: "10px" }}>
                <div style={{ display: "flex", flexDirection: "row" }}>
                  <div style={{ flex: 2, padding: "10px" }}>
                    ...
                    <p style={{ marginTop: "-8px" }}>{flightValue.flightDetails?.departureAirportInformation?.code}</p>
                    <p style={{ marginTop: "-15px" }}>{flightValue.flightDetails?.departureAirportInformation?.terminal}</p>
                  </div>
                  <div style={{ flex: 1, padding: "10px" }}>
                    <h6 style={{ marginTop: "25px" }}>
                      <span>{flightValue.flightDetails.flightStops ? flightValue.flightDetails.flightStops : 'Non Stop'}</span> (stops)
                    </h6>
                  </div>
                  <div style={{ flex: 2, padding: "10px" }}>
                    <h6>{flightValue.flightDetails?.arrivalTime}</h6>
                    <p style={{ marginTop: "-8px" }}>{flightValue.flightDetails.arrivalAirportInformation.code}</p>
        ...
        <table style={{ borderCollapse: 'collapse', width: '100%' }}>
          <tbody>
            ...
            <tr style={{}}>
              ...
              <td style={{ textAlign: 'right', padding: '8px' }}>{currency} {currency} {ticketDetails?.fareDetail?.SSRP ? ticketDetails?.fareDetail?.SSRP : 0} </td>
            </tr>
