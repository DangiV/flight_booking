...
export default function TicketPdf() {
  ...
  const localStorageData = localStorage.getItem('print');
  let reStoredValues;

  if (localStorageData) {
    try {
      reStoredValues = JSON.parse(localStorageData);
    } catch (error) {
      console.error('Error parsing JSON data from local storage:', error);
    }
  }

  console.log("reStoredValues.withAgency", reStoredValues.withAgency);
        ...
        <div className="col-12 m-auto">
          ...
          <div className='card ticketpdf' style={{ padding: '0px' }}  >
            <div className='row mt-2' style={{ marginBottom: '-25px' }}>
              ...
              {reStoredValues.withAgency === "true" ? <div className='col-6'>
