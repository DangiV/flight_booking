...
export default function Bussearching() {
    ...
    const red  = () =>{
      ...
      document.getElementById("readd").style.backgroundColor = "red";
      document.querySelector(".show").style.display = "block";
    }

    const green  = () =>{
      document.getElementById("readd").style.backgroundColor = "green" ;
      document.getElementById("read").style.backgroundColor = "red";
